...
//                 try {
//                     const response = await fetch(`http://agazatyapi.runasp.net/api/Account/UdpateUser/${userID}`, {
//                         method: "PUT",
...
//                                 <input type="email" className="form-control" name="email" onChange={handleChange} id="email" value={updatedFields.email ?? user.email} />
//                             </div>

//                             <div className="col-sm-12 col-md-6 col-lg-6 mb-3">
//                                 <label htmlFor="phoneNumber" className="form-label">رقم الهاتف</label>
//                                 <input type="tel" className="form-control" name="phoneNumber" onChange={handleChange} id="phoneNumber" value={updatedFields.phoneNumber ?? user.phoneNumber} />
//                             </div>

//                             <div className="col-sm-12 col-md-6 col-lg-6 mb-3">
//                                 <label htmlFor="governorate" className="form-label">المحافظة</label>
//                                 <input type="text" className="form-control" name="governorate" onChange={handleChange} id="governorate" value={updatedFields.governorate ?? user.governorate} />
//                             </div>

//                             <div className="col-sm-12 col-md-6 col-lg-6 mb-3">
//                                 <label htmlFor="state" className="form-label">المركز / المدينة</label>
//                                 <input type="text" className="form-control" name="state" onChange={handleChange} id="state" value={updatedFields.state ?? user.state} />
//                             </div>

//                             <div className="col-sm-12 col-md-6 col-lg-6 mb-3">
//                                 <label htmlFor="street" className="form-label">القرية / الشارع</label>
//                                 <input type="text" className="form-control" name="street" onChange={handleChange} id="street" value={updatedFields.street ?? user.street} />
//                             </div>
//                         </div>
//                     </div>
...
// export default EditProfileForHR;